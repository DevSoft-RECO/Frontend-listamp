    ...
    */
    ...
    const items = [
        ...
        },
        {
            ...
            show: authStore.hasPermission('validacion_mp'),
            children: [
        ...
        {
            id: 'modulo-validacion-consolidada',
            label: 'Validación MP y Crédito',
            ...
            show: authStore.hasPermission('validacion_mp_credito'),
            children: [
