...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    permission: ['solicitudes_ver_todo', 'solicitudes_ver_cumplimiento', 'solicitudes_ver_agencia', 'solicitudes_autorizar_jefatura', 'solicitudes_autorizar_cumplimiento'],
