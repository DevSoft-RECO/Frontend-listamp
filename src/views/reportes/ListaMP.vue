  ...
  <div>
    ...
    <div class="max-w-6xl mx-auto px-6 pb-12">
      ...
      <div class="mb-12 text-center">
        ...
        <h1 class="text-2xl font-black text-slate-800 dark:text-white tracking-tight leading-none">Sistema de Validación</h1>
        <div class="flex items-center justify-center gap-3 mt-2">
          <p class="text-[9px] uppercase font-black text-verde-cope tracking-[0.2em]">Lista Negra MP</p>
          <span class="w-1 h-1 bg-slate-300 dark:bg-slate-700 rounded-full"></span>
          <p class="text-[9px] uppercase font-bold text-slate-400 tracking-widest">Módulo de Cumplimiento v2.0</p>
        </div>
      </div>
      ...
      <div class="mb-12 max-w-2xl mx-auto px-4">
        <div class="flex items-center justify-between relative">
          <div v-for="(step, idx) in ['Búsqueda', 'Resultados', 'Verificación']" :key="idx" class="flex flex-col items-center flex-1 relative z-10">
